        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-6">
          ...
          <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-2xl max-h-[85vh] overflow-hidden flex flex-col animate-in zoom-in-95 duration-200">
            <div className="px-6 py-4 border-b border-gray-100 flex justify-between items-center bg-red-50">
              ...
              <button onClick={() => setOpen(false)} className="p-2 text-gray-700 hover:text-white hover:bg-maroon rounded-lg transition-colors">✕</button>
            </div>
            ...
            <div className="p-6 overflow-y-auto space-y-6">
              ...
              <div>
                <h3 className="text-xs font-bold text-maroon-900 uppercase tracking-widest mb-2">{getSummaryLabel()}</h3>
