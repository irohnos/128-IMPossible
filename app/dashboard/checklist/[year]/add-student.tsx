              ...
              <div className="flex-1 overflow-y-auto p-6 space-y-5 text-left">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <RestrictedInput restrictionType="number" type="tel" name="student_contact_no" placeholder="639XXXXXXXXX" className="w-full bg-gray-50 text-gray-800 text-sm px-4 py-2.5 rounded-lg border border-gray-200 focus:border-maroon focus:bg-white outline-none transition-all text-left" 
                      minLength={12} 
                      maxLength={12} 
                      pattern="[6][3][9][0-9]{9}" 
